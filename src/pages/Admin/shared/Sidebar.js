        ...
        <ul className="nav">
          ...
          <li className={ this.isPathActive('/admin/basic-ui') ? 'nav-item active' : 'nav-item' }>
            <div className={ this.state.basicUiMenuOpen ? 'nav-link menu-expanded' : 'nav-link' } onClick={ () => this.toggleMenuState('basicUiMenuOpen') } data-toggle="collapse">
              ...
              <span className="menu-title"><Trans>Inventaire</Trans></span>
              <i className="menu-arrow"></i>
            </div>
            <Collapse in={ this.state.basicUiMenuOpen }>
              <ul className="nav flex-column sub-menu">
                <li className="nav-item"> <Link className={ this.isPathActive('/admin/basic-ui/buttons') ? 'nav-link active' : 'nav-link' } to="/admin/basic-ui/buttons"><Trans>Stocks</Trans></Link></li>
                <li className="nav-item"> <Link className={ this.isPathActive('/admin/basic-ui/dropdowns') ? 'nav-link active' : 'nav-link' } to="/admin/basic-ui/dropdowns"><Trans>Ajouter Stocks</Trans></Link></li>
              </ul>
            </Collapse>
          </li>
          ...
          <li className={ this.isPathActive('/admin/icons') ? 'nav-item active' : 'nav-item' }>
            ...
            <Collapse in={ this.state.iconsMenuOpen }>
              <ul className="nav flex-column sub-menu">
                <li className="nav-item"> <Link className={ this.isPathActive('/admin/icons/mdi') ? 'nav-link active' : 'nav-link' } to="/admin/icons/mdi">Material</Link></li>
              </ul>
            </Collapse>
          </li>
          <li className={ this.isPathActive('/admin/charts') ? 'nav-item active' : 'nav-item' }>
            ...
            <Collapse in={ this.state.chartsMenuOpen }>
              <ul className="nav flex-column sub-menu">
                <li className="nav-item"> <Link className={ this.isPathActive('/admin/charts/chart-js') ? 'nav-link active' : 'nav-link' } to="/admin/charts/chart-js">Liste des Commandes</Link></li>
              </ul>
            </Collapse>
          </li>
          <li className={ this.isPathActive('/admin/user-pages') ? 'nav-item active' : 'nav-item' }>
            <div className={ this.state.userPagesMenuOpen ? 'nav-link menu-expanded' : 'nav-link' } onClick={ () => this.toggleMenuState('userPagesMenuOpen') } data-toggle="collapse">
              ...
              <span className="menu-title"><Trans>Utilisateurs</Trans></span>
              <i className="menu-arrow"></i>
            </div>
            <Collapse in={ this.state.userPagesMenuOpen }>
              <ul className="nav flex-column sub-menu">
                <li className="nav-item"> <Link className={ this.isPathActive('/admin/user-pages/login-1') ? 'nav-link active' : 'nav-link' } to="/admin/user-pages/login-1"><Trans>Liste des Utilisateurs</Trans></Link></li>
                <li className="nav-item"> <Link className={ this.isPathActive('/admin/user-pages/register-1') ? 'nav-link active' : 'nav-link' } to="/admin/user-pages/register-1"><Trans>Ajouter</Trans></Link></li>
              </ul>
            </Collapse>
          </li>
