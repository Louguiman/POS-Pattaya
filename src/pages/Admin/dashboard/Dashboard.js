              ...
              <div className="card-body">
                <div className="row">
                  <div className="col-xl-3 col-lg-6 col-sm-6 grid-margin-xl-0 grid-margin">
                    <div className="d-flex">
                      <div className="wrapper">
                        <h3 className="mb-0 font-weight-semibold">4</h3>
                        <h5 className="mb-0 font-weight-medium text-primary">Utilisateurs</h5>
                  ...
                  <div className="col-xl-3 col-lg-6 col-sm-6 mt-md-0 mt-4 grid-margin-xl-0 grid-margin">
                    <div className="d-flex">
                      <div className="wrapper">
                        ...
                        <h5 className="mb-0 font-weight-medium text-primary">Total des Commandes</h5>
                        <p className="mb-0 text-muted"></p>
                      </div>
                      <div className="wrapper my-auto ml-auto ml-lg-4">
                  ...
                  <div className="col-xl-3 col-lg-6 col-sm-6 mt-md-0 mt-4 grid-margin-xl-0 grid-margin">
                    <div className="d-flex">
                      <div className="wrapper">
                        <h3 className="mb-0 font-weight-semibold">150 000 FCFA</h3>
                        <h5 className="mb-0 font-weight-medium text-primary">Total des Ventes</h5>
          ...
          <div className="col-md-4">
            <div className="row">
              <div className="col-md-12 grid-margin">
                <div className="card">
                  <div className="card-body">
                    <h4 className="card-title mb-0">Dernier Connecté</h4>
